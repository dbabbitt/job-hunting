...
######################################
## SGDClassifier is-other functions ##
######################################
class IsOtherSgdClassifier(PosSymbolSgdClassifier):
